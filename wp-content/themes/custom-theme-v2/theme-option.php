	...
	if ( ! isset( $_REQUEST['settings-updated'] ) )
        ...
        <form method="post" action="options.php" >
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Dribble', 'sampletheme' ); ?></th>
					<td>
						<input id="cOptn[dribble]" class="large-text" type="text" name="cOptn[dribble]" value="<?php echo esc_textarea( $options['dribble'] ?? ''); ?>">
		                <label class="description" for="cOptn[dribble]"><?php _e( 'Please Enter Dribble URL', 'sampletheme' ); ?></label>
					</td>
				</tr>
